 ...
 * @author Ksenija
 */
public class FormIzvestajOServisu extends javax.swing.JDialog {

    PrijavaKvara pk;

    /**
     * Creates new form FormIzvestajOServisu
     */
    public FormIzvestajOServisu(JDialog parent, boolean modal, PrijavaKvara pk) {
        super(parent, modal);
        initComponents();
        this.pk = pk;
        setTitle("Izvestaj o servisu");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        StavkaIzvestaja si = new StavkaIzvestaja(-1, null, pk, Integer.parseInt(txtKolicina.getText()), rd);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            IzvestajOServisu i = new IzvestajOServisu(-1, Integer.parseInt(txtUkupnaCena.getText()), sdf.parse(datumPrijave), txtNapomena.getText(), n, pk, mt.getLista());
            klijentkontroler.KlijentKontroler.getInstance().sacuvajIzvestaj(i);
            
            JOptionPane.showMessageDialog(this,"Sistem je zapamtio izvestaj!");
            PretragaPrijava pp=(PretragaPrijava) getParent();
            pp.osvezi();
            this.dispose();
            ...
            JOptionPane.showMessageDialog(this,"Sistem ne moze da zapamti podatke o izvestaju");
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormIzvestajOServisu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void srediFormu() {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy HH:mm:ss");
            txtOpis.setText("Forma za kreiranje servisnog izvestaja po prijavi sa sifrom: " + pk.getPrijavaID() + "\n\n" + "Datum i vreme prijave: " + sdf.format(pk.getDatumVremePrijave()) + "\n\n" + "Prijavu kreirao serviser: " + pk.getServiser().toString() + "\n\n" + "Klijent podnosilac prijave: " + pk.getKlijent().toString());
